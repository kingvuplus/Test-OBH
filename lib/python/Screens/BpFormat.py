...
class Bp_UsbFormat(Screen):
    ...
    def __init__(self, session):
        ...
        msg += _('Please be sure that your usb drive is NOT CONNECTED to your Spark box before you continue.\n')
    ...
    def stepOne(self):
        msg = _('Connect your usb storage to your Spark box\n')
    ...
    def succesS(self):
        mybox = self.session.openWithCallback(self.hreBoot, MessageBox, _("Your Spark Box will be now restarted to generate a new device UID.\nDon't forget to remap your device after the reboot.\nPress ok to continue"), MessageBox.TYPE_INFO)
